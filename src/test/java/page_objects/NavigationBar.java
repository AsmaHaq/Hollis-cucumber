...
public class NavigationBar {
    ...
    private static final Logger LOGGER= LogManager.getLogger(NavigationBar.class);
     ...
     //Create a constructor and pass the object parameter and initialize the value.
    public NavigationBar(WebDriver driver){
        this.driver=driver;
    }

    //Create some method
    //1st method is Hover the mouse
    public NavigationBar mouseHoverToRates(){
        ...
        //Same class return use "return this"
        return this;
    }

    public RealApr navigateToRealApr(){
        LOGGER.debug("Clicking on the RealApr Link");
        ActOn.element(driver,RealAprLink).click();
        //returning new page objects of the RealApr page so "return new RealApr();
